...
export const ListCampaignsResponseItem = zod.object({
  ...
  "region": zod.string().nullish().describe('Target region, e.g. MENA | US | EU | GLOBAL'),
  "messagesPerHour": zod.number().optional(),
  "totalMessagesSent": zod.number().optional(),
  "totalResponses": zod.number().optional(),
  "credentials": zod.string().nullish().describe('JSON encoded platform credentials'),
...
export const ListTemplatesResponseItem = zod.object({
  "id": zod.number(),
  "name": zod.string(),
  "content": zod.string().describe('Template text. Use {streamer_name} as placeholder'),
...
export const ListStreamersResponseItem = zod.object({
  ...
  "region": zod.string().nullish().describe('Region, e.g. MENA | US | EU | GLOBAL'),
  "status": zod.string().optional().describe('pending | contacted | responded | joined | ignored'),
